"""Entry point: `iwpod <prepare|train|eval|infer|export> [options]`."""
import argparse
...
from iwpod.cli import prepare as _prepare
...
def main(argv=None):
    ...
    _prepare.register(sub.add_parser("prepare-data", help="Convert scene folders to train/val layout"))
